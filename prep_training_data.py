...
# Apply the mapping function to the 'annotation_severity' column
if 'annotation_severity' in train_df.columns:
    train_df['annotation_severity'] = train_df['annotation_severity'].apply(map_severity)

# Save the cleaned and processed DataFrame to a new CSV file
train_df.to_csv('cleaned_data/training.csv', index=False)
print("Columns removed, data split into new columns, empty columns removed, 'def_text' column removed, severity mapped, and file saved successfully.")